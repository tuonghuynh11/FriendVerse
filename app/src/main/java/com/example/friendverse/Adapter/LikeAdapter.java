...
public class LikeAdapter extends  RecyclerView.Adapter<com.example.friendverse.Adapter.LikeAdapter.ViewHolder>{
        ...
        public LikeAdapter(Context sContext, List<User> sUser) {
        ...
        public void setOnItemClickListener(com.example.friendverse.Adapter.LikeAdapter.OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull com.example.friendverse.Adapter.LikeAdapter.ViewHolder holder, int position) {
